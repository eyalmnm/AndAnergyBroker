...
class MeetingEditReviewFragment : Fragment() {
    private val TAG: String = "MeetingEditReviewFrag"

    private var contactsList: List<DecisionMakerModel>? = null
    private var meetingResultStatus: Int? = null

    interface OnMeetingEditConfirmReviewListener {
        fun onMeetingEditConfirmReview(confirm: Boolean)
        fun sendDataToFragment(fragment: MeetingEditReviewFragment)
    }

    private var listener: OnMeetingEditConfirmReviewListener? = null
    ...
    companion object {
        ...
        fun newInstance(): MeetingEditReviewFragment {
            return MeetingEditReviewFragment()
        }
    }

    override fun onAttach(context: Context?) {
        super.onAttach(context)
        listener = context as OnMeetingEditConfirmReviewListener
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        saveButton.setOnClickListener {
            if (checkValidity()) {
                if (listener != null) {
                    listener?.onMeetingEditConfirmReview(true)
                }
            }
        }
        ...
        cancelButton.setOnClickListener {
            if (listener != null) {
                listener?.onMeetingEditConfirmReview(false)
            }
        }
    }
